...
public class FidoClient: FidoClientProtocol {
    ...
    public func register(aaid: String, BiometricsAssertionScheme: String, accessToken: String, registrationUrl: String, privateKeyLabel: String, registrationResponseEndpoint: String, keyIDPrefix: String) throws -> Bool {
        do {
            let registrationResponse = try startRegistration(aaid: aaid, BiometricsAssertionScheme: BiometricsAssertionScheme, accessToken: accessToken, registrationUrl: registrationUrl, privateKeyLabel: privateKeyLabel, keyIDPrefix: keyIDPrefix)
    ...
    public func startRegistration(aaid: String, BiometricsAssertionScheme: String, accessToken: String, registrationUrl: String, privateKeyLabel: String, keyIDPrefix: String) throws -> String {
        do {
            ...
            let encodedResponse = try encodingHandler.getEncodedRegistrationResponse(aaid: aaid, BiometricsAssertionScheme: BiometricsAssertionScheme, privateKeyLabel: privateKeyLabel, with: request, keyIDPrefix: keyIDPrefix)
